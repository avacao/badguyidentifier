...
th_dim_model = VGG_19() # Create your theano model here with TH dim ordering

K.set_image_data_format('channels_last')
tf_dim_model = vgg19.VGG19() # Create your tensorflow model with TF dimordering here

model_weights = [VGG19_ILSVRC_WEIGHT_PATH] # Add names of theano model weight file paths here.
